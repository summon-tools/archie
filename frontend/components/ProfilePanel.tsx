    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-th-surface rounded-2xl border border-th p-6">
          <h2 className="text-base font-semibold text-th-primary mb-1">Account</h2>
        ...
        {/* Appearance */}
        <div className="bg-th-surface rounded-2xl border border-th p-6">
          <h2 className="text-base font-semibold text-th-primary mb-1">Appearance</h2>
          <p className="text-sm text-th-dimmed mb-4">Choose your preferred color theme.</p>
        ...
        {/* Change Password */}
        <div className="bg-th-surface rounded-2xl border border-th p-6">
          <h2 className="text-base font-semibold text-th-primary mb-1">Change Password</h2>
          <p className="text-sm text-th-dimmed mb-4">Update your account password.</p>
          <div className="space-y-3">
            <div>
              <label className="block text-sm font-medium text-th-secondary mb-1">Current Password</label>
              <input
                type="password"
            ...
            <div>
              <label className="block text-sm font-medium text-th-secondary mb-1">New Password</label>
              <input
                type="password"
                value={newPassword}
            ...
            <div>
              <label className="block text-sm font-medium text-th-secondary mb-1">Confirm New Password</label>
              <input
                type="password"
