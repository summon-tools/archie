...
import { getPlanExecutionElapsedMs, PlanExecutionError, resumePlanExecution } from "@/lib/server/plan-execution";
...
export async function POST(
  ...
  try {
    ...
    resumePlanExecution({ appId: Number(appId), roomId: Number(roomId) });
